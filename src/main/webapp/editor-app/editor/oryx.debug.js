...
ORYX.Core.StencilSet.StencilSet = Clazz.extend({
    ...
    construct: function(source, modelMetaData, editorId){
		...
		if(ORYX.CONFIG.BACKEND_SWITCH) {
			...
			new Ajax.Request(ACTIVITI.CONFIG.contextRoot + '/activitiController/getStencilset.do?version=' + Date.now(), {
				asynchronous: false,
				method: 'get',
				onSuccess: this._init.bind(this),
				onFailure: this._cancelInit.bind(this)
...
function init() {
    ...
    // Else fetch the model from server and display editor
		...
		var modelUrl = "./activitiController/getEditorJson.do?modelId="+modelId;
