...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="projectController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
						  	 <textarea style="width:400px;height:50px;" class="inputxt" rows="6" id="projectIntro" name="projectIntro"
						  	 ignore="ignore"
						  	 ></textarea>
							<span class="Validform_checktip"></span>
