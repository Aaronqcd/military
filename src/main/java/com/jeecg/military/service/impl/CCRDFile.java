...
public class CCRDFile {
	...
	static // 通过 sPath.matches(matches) 方法的返回值判断是否正确
	// sPath 为路径字符串
	boolean flag = false;
	static File file;
	...
	public static boolean deleteFile(String file_path) {// 删除单个文件
		flag = false;
	...
	public static String createTempFile(String prefix, String suffix,
		...
		public static void main(String[] args) {
			String file_path = "E:/tools/apache-tomcat-7.0.67-windows-x64/apache-tomcat-7.0.67/attachment/qualitymonitoring/upload/data/word.doc";// 创建目录
			CCRDFile.deleteFile(file_path);// 调用方法创建目录
